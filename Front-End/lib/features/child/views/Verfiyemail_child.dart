...
/// Confirms a pending email change for a child (PATCH user/confirm-email).
class VerifyEmailChild extends StatefulWidget {
  const VerifyEmailChild({super.key});

  @override
  State<VerifyEmailChild> createState() => _VerifyEmailChildState();
}

class _VerifyEmailChildState extends State<VerifyEmailChild> {
  String otpCode = "";
