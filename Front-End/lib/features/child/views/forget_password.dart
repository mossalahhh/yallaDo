...
import 'package:yallado/features/child/views/verify_newpassword.dart';
import 'package:yallado/features/parents/views/verify_email.dart';

import '../../../core/utils/app_colors.dart';
import 'Verfiyemail_child.dart';

class ForgetPasswordChild extends StatelessWidget {
  const ForgetPasswordChild({super.key});
                  ...
                  CustomButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => VerifyNewpasswordChild(),
                        ),
                      );
                    },
                  ),
