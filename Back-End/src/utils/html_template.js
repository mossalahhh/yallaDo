...
export const changeEmailTemp = (code) => `<!--
* This email was built using Tabular.
-->
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" 
"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<tr>
<td align="center" style="font-size:15px;line-height:22px;color:#424040;">
We received a request to change your email address in YallaDo.
Please use the verification code below to confirm your new email.
</td>
</tr>
...
<tr>
<td align="center" style="font-size:14px;line-height:22px;color:#424040;">
If you did not request this change, please ignore this email or secure your account immediately.
</td>
</tr>
